...
async function loadApplication(cell_id, path) {
  ...
  const packages = ['https://cdn.holoviz.org/panel/wheels/bokeh-3.7.1-py3-none-any.whl', 'https://cdn.holoviz.org/panel/wheels/panel-1.6.2-py3-none-any.whl', 'pyodide-http'];
  if (path != null) {
