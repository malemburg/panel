...
async function startApplication() {
  ...
  const env_spec = ['https://cdn.holoviz.org/panel/wheels/bokeh-3.7.1-py3-none-any.whl', 'https://cdn.holoviz.org/panel/1.6.2/dist/wheels/panel-1.6.2-py3-none-any.whl', 'pyodide-http==0.2.1', 'numpy', 'pandas', 'param']
